...
<svelte:head>
	...
	<meta name="description" content="Professional portfolio of work by Aryan Srivastava" />
</svelte:head>
...
<div class="space-y-8">
	<div>
		...
		<p class="text-[var(--color-text-muted)]">
			A showcase of polished and professional work.
		</p>
	</div>
