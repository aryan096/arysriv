...
tags:
  ...
  - Creative Coding
published: true
liveUrl: https://emergentia.arysriv.com/
---

## Overview

[emergentia.arysriv.com](https://emergentia.arysriv.com/) is an experiment in building emergent behavior from simple local rules on a 2D grid. Different cell types interact according to their own rule sets, producing larger system-level patterns that resemble natural processes.
